...
export default function TierStandingsPage() {
  ...
  // Suppress unused variable warning — isDefender is used for potential future UI branching
  void isDefender
      ...
      <div className="w-full max-w-[480px] relative" style={{ minHeight: '100dvh' }}>
        ...
        <div className="pt-[max(1rem,env(safe-area-inset-top))] px-6 pb-2">
          <div className="flex items-center gap-3 mb-1">
            <button onClick={() => { hapticLight(); router.push(`/ladder/${clubId}`) }} className="cursor-pointer text-white/40 hover:text-white transition-colors">
            ...
            >
              {!userTeam && (
                ...
                >
                  ...
                  <motion.button
                    whileTap={{ scale: 0.95 }}
                    onClick={() => { hapticLight(); router.push(`/ladder/${clubId}/${tierId}/register`) }}
