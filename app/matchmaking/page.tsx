                ...
                <div className="p-4">
                  ...
                  {hasJoined ? (
                    <div className="space-y-2">
                      ...
                      <a
                        href={`https://wa.me/?text=${encodeURIComponent(`Hey! I just joined the Match Day game at ${match.venue} for ${match.date} · ${match.time}. Let's play!`)}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-full py-2.5 bg-[#25D366] text-white font-bold rounded-xl text-xs uppercase tracking-wider flex items-center justify-center gap-2 hover:bg-[#25D366]/90 transition-all"
                      >
